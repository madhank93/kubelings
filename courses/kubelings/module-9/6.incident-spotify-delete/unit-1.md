---
kind: unit
title: "Incident file — deleting every cluster, twice (Spotify, 2019)"
name: incident-spotify-delete-unit
---
...
> · [full case study](https://kubelings.madhan.app/incidents/spotify-delete/)
