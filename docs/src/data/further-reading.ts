...
export const FURTHER_READING: Reading[] = [
  ...
  { company: 'Gravitational', title: 'Experiences running PostgreSQL on Kubernetes (failover & data loss)', url: 'https://goteleport.com/blog/running-postgresql-on-kubernetes/', module: 'M3' },
  { company: 'Turnitin',      title: 'Kubernetes and the menace ELB — the tale of an outage', url: 'https://itnext.io/kubernetes-and-the-menace-elb-the-tale-of-an-outage-c00bef678fc0', module: 'M4' },
  { company: 'Saltside',      title: 'Our failure migrating to Kubernetes (ELB, kops, backend errors)', url: 'https://engineering.saltside.se/our-failure-migrating-to-kubernetes-25c28e6dd604', module: 'M8' },
];
